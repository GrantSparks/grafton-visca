...
fn test_blocking_camera_tcp_connect() {
    ...
    let result = BlockingCamera::<GenericVisca, _>::connect_tcp("invalid:address");
    ...
    let result = BlockingCamera::<GenericVisca, _>::connect_tcp("192.168.1.100:5678");
    assert!(
        result.is_err(),
...
fn test_blocking_camera_udp_connect() {
    ...
    let result = BlockingCamera::<GenericVisca, _>::connect_udp("invalid:address");
    assert!(result.is_err(), "Invalid address should fail");
    ...
    let result = BlockingCamera::<GenericVisca, _>::connect_udp("192.168.1.100:52381");
    assert!(
        result.is_ok(),
