...
impl CommandFixtures {
    ...
    pub fn power_commands() -> HashMap<&'static str, Vec<u8>> {
        ...
        commands.insert("power_on", vec![0x81, 0x01, 0x04, 0x00, 0x02, 0xFF]);
    ...
    pub fn zoom_commands() -> HashMap<&'static str, Vec<u8>> {
        let mut commands = HashMap::new();
        commands.insert("zoom_stop", vec![0x81, 0x01, 0x04, 0x07, 0x00, 0xFF]);
        commands.insert("zoom_tele_std", vec![0x81, 0x01, 0x04, 0x07, 0x02, 0xFF]);
        commands.insert("zoom_wide_std", vec![0x81, 0x01, 0x04, 0x07, 0x03, 0xFF]);
        commands.insert("zoom_tele_var_5", vec![0x81, 0x01, 0x04, 0x07, 0x25, 0xFF]);
    ...
    pub fn focus_commands() -> Vec<(&'static str, Vec<u8>)> {
        vec![
            ("focus_auto", vec![0x81, 0x01, 0x04, 0x38, 0x02, 0xFF]),
            ("focus_manual", vec![0x81, 0x01, 0x04, 0x38, 0x03, 0xFF]),
            ("focus_stop", vec![0x81, 0x01, 0x04, 0x08, 0x00, 0xFF]),
            ("focus_far", vec![0x81, 0x01, 0x04, 0x08, 0x02, 0xFF]),
