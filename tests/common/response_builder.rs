...
mod tests {
    ...
    fn test_inquiry_builder() {
        ...
        let response = ResponseBuilder::inquiry()
            ...
            .build();
        assert_eq!(response, vec![0x90, 0x50, 0x05, 0x02, 0x0A, 0x0B, 0x0C, 0x0D, 0xFF]);
    }
    ...
    fn test_pattern_helpers() {
        ...
        assert_eq!(response, vec![0x90, 0x50, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0xFF]);
