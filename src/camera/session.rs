...
// Control trait imports are now auto-generated via macros
#[cfg(feature = "async")]
use crate::camera::CameraSend;
// Removed unused imports - these were only used in the manual forwarding implementations
use crate::executor::Executor;
// Removed unused type imports - these were only used in the manual forwarding implementations
// All control trait delegations are auto-generated by macros
