...
use crate::{
    ...
    capabilities::{ProfileMetadata, Exposure},
    command::{
    ...
    T: Transport,
{
    ...
    fn set_iris(&self, level: crate::types::IrisLevel) -> impl Future<Output = Result<(), Error>> + '_;
    
    /// Set brightness level - returns a future.
    fn set_brightness(&self, level: crate::types::BrightnessLevel) -> impl Future<Output = Result<(), Error>> + '_;
    ...
    fn set_gain_limit(&self, limit: crate::types::GainLimit) -> impl Future<Output = Result<(), Error>> + '_;
    
    /// Set dynamic range level - returns a future.
    fn set_dynamic_range(&self, level: crate::types::DynamicRangeLevel) -> impl Future<Output = Result<(), Error>> + '_;
    
    /// Set color temperature - returns a future.
    fn set_color_temperature(&self, temp: crate::types::ColorTemperature) -> impl Future<Output = Result<(), Error>> + '_;
}
