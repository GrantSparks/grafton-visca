...
use crate::capabilities::{ProfileMetadata, PanTilt, pan_tilt::PanTiltExt};
use crate::command::inquiry::InquiryCommand;
use crate::command::{AntiFlickerMode, AutoFocusSensitivity, Command, ExposureMode, FocusZone, InquiryResponse, Response, SharpnessMode, WhiteBalanceMode};
    ...
    T: crate::transport::blocking::BlockingTransport,
{
    ...
    fn get_version(&mut self) -> Result<(u16, u16, u32, u8), Error> {
        ...
        let parsed = Response::parse(&response)?;
        match parsed {
            Response::InquiryResponse(InquiryResponse::Version { vendor, model, rom_version, max_socket }) => {
