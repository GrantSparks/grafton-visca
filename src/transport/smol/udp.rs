//! smol UDP transport implementation using the generic async_udp module.
...
///
/// This is a type alias for the generic UDP transport specialized for smol's UdpSocket.
pub type Udp = crate::transport::async_udp::Udp<UdpSocket>;

/// Helper methods for creating smol UDP transports.
impl Udp {
