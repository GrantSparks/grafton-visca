...
//!
//! This module implements automatic detection of Sony encapsulated
//! vs raw VISCA protocol modes. It probes the camera with both formats to
//! determine which protocol the camera expects.
//!
//! The implementation uses a runtime-agnostic state machine that works
...
// Public API for protocol detection
...
impl ProtocolDetector {
    ...
    ///
    /// This implements the detection algorithm:
        ...
        E: Executor,
    {
        ...
        // Try Sony encapsulated format first (priority order)
        ...
        E: Executor,
    {
        ...
        // Use the async runner with the DetectorCore FSM
    ...
    ///
    /// This implements the same detection algorithm as the async version:
    /// 1. Try Sony encapsulated format first (most cameras support this)
    /// 2. If no response, fallback to raw VISCA format
    /// 3. If neither works, return NoResponse
    ///
        ...
        T: crate::transport::SyncTransport + ?Sized,
    {
        ...
        // Use the blocking runner with the DetectorCore FSM
