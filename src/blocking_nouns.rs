...
use crate::{
    ...
    capabilities::{
        ...
        HasContrastControl, HasDefogLevel, HasDigitalZoomToggle, HasDirectMenuControl,
        HasDirectZoom, HasExposure, HasExposureCompensation, HasExposureMode, HasFocus,
        HasFocusLock, HasFocusNearLimitInquiry, HasFocusZone, HasFocusZoneInquiry, HasGammaControl,
        HasHueControl, HasImageFlip, HasImageFreeze, HasImageMirror, HasImageProcessing,
