...
fn test_blocking_compilation() {
    ...
    use blocking::{
        ColorOps, ExposureOps, FocusOps, ImageProcessingOps, InquiryOps,
        NDFilterOps, PanTiltOps, PanTiltInquiryOps, PowerOps, PresetsOps,
        SystemOps, TallyOps, WhiteBalanceOps, ZoomOps
    };
...
fn test_async_compilation() {
    ...
    // This function just needs to compile - we're verifying trait implementations exist
    async fn _test_trait_methods(camera: &r#async::Camera) {
        // ZoomOps
