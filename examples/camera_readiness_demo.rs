...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let handle1 = tokio::spawn(async move {
        ...
        let result = cam1.send_command(&InquiryCommand::PanTiltPosition).await;
    ...
    let handle2 = tokio::spawn(async move {
        ...
        let result = cam2.send_command(&InquiryCommand::ZoomPosition).await;
    ...
    let handle3 = tokio::spawn(async move {
        ...
        let result = cam3.send_command(&InquiryCommand::PanTiltPosition).await;
