...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "  Tally::RedOn encoded size: {} (fits in MAX_SIZE: {})",
        size,
        size <= Tally::MAX_SIZE
    );
    ...
    println!(
        "  Tally::Flash encoded size: {} (fits in MAX_SIZE: {})",
        size,
        size <= Tally::MAX_SIZE
    );
    ...
    println!(
        "  Spotlight::On encoded size: {} (fits in MAX_SIZE: {})",
        size,
    ...
    println!(
        "  AddressSetCommand encoded size: {} (exact match: {})",
        size,
        size == AddressSetCommand::MAX_SIZE
    );

    println!(
        "  InterfaceClearCommand MAX_SIZE: {}",
        InterfaceClearCommand::MAX_SIZE
    );
    ...
    println!(
        "  InterfaceClearCommand encoded size: {} (exact match: {})",
        size,
        size == InterfaceClearCommand::MAX_SIZE
    );

    println!(
        "  OnePushTriggerCommand MAX_SIZE: {}",
        OnePushTriggerCommand::MAX_SIZE
    );
    ...
    println!(
        "  OnePushTriggerCommand encoded size: {} (exact match: {})",
        size,
        size == OnePushTriggerCommand::MAX_SIZE
    );
